...
Difficulty	  = 2	; 0 = original, 1 = easy, 2 = normal (easy does not have every level file)
...
ObjPosSBZPlatform_Index:
		...
		dc.w ObjPos_SBZ1pf1-ObjPos_Index, ObjPos_SBZ1pf2-ObjPos_Index
		dc.b $FF, $FF, 0, 0, 0,	0
ObjPos_GHZ1:	if Difficulty=0
		binclude	"objpos/ghz1.bin"
		elseif Difficulty=1
		binclude	"objpos/ghz1_e.bin"
		else
		binclude	"objpos/ghz1_n.bin" ; note: this layout file is a copy of ghz1.bin
		endif
		even
ObjPos_GHZ2:	if Difficulty=0
		binclude	"objpos/ghz2.bin"
		elseif Difficulty=1
		binclude	"objpos/ghz2_e.bin"
		else
		binclude	"objpos/ghz2_n.bin"
		endif
		even
ObjPos_GHZ3:	
	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/ghz3_e.bin"
		else
		binclude	"objpos/ghz3_n.bin"
		endif
	else
		if Difficulty=0
...
ObjPos_LZ1:	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/lz1_e.bin" ; note: this layout file is a copy of lz1 (JP1).bin
		else
		binclude	"objpos/lz1_n.bin"
		endif
	else
		if Difficulty=0
		...
		even
ObjPos_LZ2:	if Difficulty=0
		binclude	"objpos/lz2.bin"
		elseif Difficulty=1
		binclude	"objpos/lz2_e.bin" ; note: this layout file is a copy of lz2.bin
		else
		binclude	"objpos/lz2_n.bin"
		endif
		even
ObjPos_LZ3:	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/lz3_e.bin"
		else
		binclude	"objpos/lz3_n.bin"
		endif
	else
		if Difficulty=0
		...
		even
ObjPos_SBZ3:	if Difficulty=0
		binclude	"objpos/sbz3.bin"
		elseif Difficulty=1
		binclude	"objpos/sbz3_e.bin" ; note: this layout file is a copy of sbz3.bin
		else
		binclude	"objpos/sbz3_n.bin"
		endif
		even
...
ObjPos_MZ1:	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/mz1_e.bin"
		else
		binclude	"objpos/mz1_n.bin"
		endif
	else
		if Difficulty=0
		...
		even
ObjPos_MZ2:	if Difficulty=0
		binclude	"objpos/mz2.bin"
		elseif Difficulty=1
		binclude	"objpos/mz2_e.bin"
		else
		binclude	"objpos/mz2_n.bin"
		endif
		even
ObjPos_MZ3:	if Difficulty=0
		binclude	"objpos/mz3.bin"
		elseif Difficulty=1
		binclude	"objpos/mz3_e.bin"
		else
		binclude	"objpos/mz3_n.bin"
		endif
		even
ObjPos_SLZ1:	if Difficulty=0
		binclude	"objpos/slz1.bin"
		elseif Difficulty=1
		binclude	"objpos/slz1_e.bin" ; note: this layout file is a copy of slz1.bin i think
		else
		binclude	"objpos/slz1_n.bin" ; note: this layout file is a copy of slz1.bin i think
		endif
		even
ObjPos_SLZ2:	if Difficulty=0
		binclude	"objpos/slz2.bin"
		elseif Difficulty=1
		binclude	"objpos/slz2_e.bin"
		else
		binclude	"objpos/slz2_n.bin"
		endif
		even
ObjPos_SLZ3:	if Difficulty=0
		binclude	"objpos/slz3.bin"
		elseif Difficulty=1
		binclude	"objpos/slz3_e.bin" ; note: this layout file is a copy of slz3.bin i think
		else
		binclude	"objpos/slz3_n.bin"
		endif
		even
ObjPos_SYZ1:	if Difficulty=0
		binclude	"objpos/syz1.bin"
		elseif Difficulty=1
		binclude	"objpos/syz1_e.bin" ; note: this layout file is a copy of syz1.bin i think
		else
		binclude	"objpos/syz1_n.bin"
		endif
		even
ObjPos_SYZ2:	if Difficulty=0
		binclude	"objpos/syz2.bin"
		elseif Difficulty=1
		binclude	"objpos/syz2_e.bin"
		else
		binclude	"objpos/syz2_n.bin"
		endif
		even
ObjPos_SYZ3:	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/syz3_e.bin" ; note: this layout file is a copy of syz3 (JP1).bin i think
		else
		binclude	"objpos/syz3_n.bin"
		endif
	else
		if Difficulty=0
...
ObjPos_SBZ1:	if Revision=0
		...
		elseif Difficulty=1
		binclude	"objpos/sbz1_e.bin"
		else
		binclude	"objpos/sbz1_n.bin"
		endif
	else
		if Difficulty=0
		...
		even
ObjPos_SBZ2:	if Difficulty=0
		binclude	"objpos/sbz2.bin"
		elseif Difficulty=1
		binclude	"objpos/sbz2_e.bin" ; note: this layout file is a copy of sbz2.bin i think
		else
		binclude	"objpos/sbz2_n.bin"
		endif
		even
ObjPos_FZ:	if Difficulty=0
		binclude	"objpos/fz.bin"
		elseif Difficulty=1
		binclude	"objpos/fz_e.bin"
		else
		binclude	"objpos/fz_n.bin"
		endif
		even
